...
--CREATE DATABASE LUM;
--CREATE USER lum_user@localhost IDENTIFIED BY '666';
--GRANT ALL PRIVILEGES ON LUM.* TO lum_user@localhost IDENTIFIED BY '666'; 
...
CREATE TABLE `auditoria` (
  ...
  CONSTRAINT `auditoria_ibfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `entregas` (
  ...
  `evidencia_foto` text DEFAULT NULL,
  `evidencia_firma` text DEFAULT NULL,
  ...
  `penalizacion` decimal(8,2) DEFAULT 0.00,
...
-- Dump completed on 2025-11-16  2:22:23
